...
function classifyCanvas() {
    classifier.classify("myCanvas", gotResult())
}
...
console.log(results);
drawn_sketch = quick_draw_data_set.results[0].object;
document.getElementById("result_para_tag").innerHTML = "Your Sketch : "+ drawn_sketch;
document.getElementById("result_object_accuracy").innerHTML = "Confidence : "+ Math.round(result[0],confidence*100+"%");
}
